...
public class SysroleInfoController extends AdvancedAjaxBaseController  {
    ...
    @RequestMapping("/sysroleInfoView.dhtml")
    public String init() {
        return "sysroleinfo/sysroleinfo";
    }
    ...
    public void queryObject(HttpServletRequest request, HttpServletResponse response) {
        ...
        tblSysroleInfo.setRoleNo(jsonObject.get("id_key").toString());// 联合主键用逗号分割
        ...
        try {
            ...
            Map tblSysroleInfo_map = afterLogic(request, JSONObject.fromObject(tblSysroleInfo));
            result.put("tblSysroleInfo", tblSysroleInfo_map);
    ...
    public void insert(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            TblSysroleInfo tblSysroleInfo = new TblSysroleInfo();
            try {
                MapObjTransUtils.mapToObj(tblSysroleInfo, paramMap);
            } catch (Exception e) {
                logger.error("对象转化异常", e);
            }
            tblSysroleInfo.setCreateTime(DateUtils.getCurrDateTime());
            tblSysroleInfo.setUpTime(DateUtils.getCurrDateTime());
            try {
            } catch (Exception e) {
                logger.error("对象转化异常", e);
            }
            logger.info("传入参数:tblSysroleInfo:" + JSONObject.fromObject(tblSysroleInfo).toString());
            int count = sysroleInfoLogic.insertSysroleInfo(tblSysroleInfo);
    ...
    public void edit(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            logger.info("传入参数:tblSysroleInfo:" + JSONObject.fromObject(tblSysroleInfo).toString());
            int count = sysroleInfoLogic.updateSysroleInfo(tblSysroleInfo);
            if (count == 0) {
    ...
    public void del(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            for (String s : id_key.split(";")) { // 多个主键用分号分割
                logger.info("尝试删除:" + s);
                TblSysroleInfo tblSysroleInfo = new TblSysroleInfo();
                tblSysroleInfo.setRoleNo(s);// 联合主键用逗号分割
                try {
                    count += sysroleInfoLogic.deleteSysroleInfo(tblSysroleInfo);
                } catch(Exception e) {
    ...
    public void search(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            paramMap = sysroleInfoLogic.queryPageSysroleInfo(paramMap);
