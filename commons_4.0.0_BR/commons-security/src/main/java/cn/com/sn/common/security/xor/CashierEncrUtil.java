package cn.com.sn.common.security.xor;
...
public class CashierEncrUtil {
	...
	* @throws
	...
	public static void main(String[] args) throws Exception{
	    ...
	    String decrypt = CashierEncrUtil.decrypt(encrypt);  
	    System.out.println("解密后：" + decrypt); 
	    /*2.Md5签名*/
	    String md5Str = CashierEncrUtil.encodeMessage(content);
