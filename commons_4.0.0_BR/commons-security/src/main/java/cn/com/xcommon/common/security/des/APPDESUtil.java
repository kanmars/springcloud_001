...
public class APPDESUtil {
    ...
    public static void main(String[] args) throws Exception {
		...
		String str1 = "msg1234";
		// DES 加密字符串
		String str2 = APPDESUtil.encryptDES(str1, "des-0001");
		System.out.println(str2);
		// DES 解密字符串
		String str3 = APPDESUtil.decryptDES(str2, "des-0001");
		System.out.println(str2);
    	...
    	/* String plaintext = "yangbo";
    	     try {
    	     System.out.println(APPDESUtil.encryptDES(plaintext, "12345678"));
    	     } catch (Exception e) {
    	     e.printStackTrace();
    	     }*/
