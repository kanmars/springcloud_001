...
public class SecureIdentityLoginModule {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println("Encoded password: " + SecureIdentityLoginModule.encode("root"));
        System.out.println("decoded password: " + new String(SecureIdentityLoginModule.decode("-64d29910cc13d220ea2e89c490b1e4bf")));
        System.out.println("Encoded password: " + SecureIdentityLoginModule.encode("123456"));
        System.out.println("decoded password: " + new String(SecureIdentityLoginModule.decode("29ec2159f152a824fccd68a871b83415")));
    }
}
